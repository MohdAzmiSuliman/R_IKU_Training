...
asthmads_savh <- read_sav("../asthma_ds.sav")
asthmads_savh <- as_factor(asthmads_savh)

asthmads_savh <- haven::read_sav("../asthma_ds.sav") # also achieve same
...
asthmads_savr <- import("../asthma_ds.sav")
asthmads_savr <- rio::import("../asthma_ds.sav") # also achieve same
...
```{r}
asthmads_csv <- read.csv("../asthma_ds.csv")
...
```{r}
asthmads_csv <- rio::import("../asthma_ds.csv")
...
```{r}
asthma_ds <- read.csv("../asthma_ds_nolab.csv")
...
::: {.callout-note}
Redundant with descriptive analysis
:::
...
```{r}
asthma_ds0 <- read.csv("../asthma_ds_nolab.csv") 
